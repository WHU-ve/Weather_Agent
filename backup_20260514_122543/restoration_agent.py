    ...
    def execute_plan(self, plan, input_image_path, output_dir):
        ...
        while step < len(active_plan):
            ...
            if temp_outputs:
                ...
                best_output, score = self.evaluator.select_best(candidate_pool, task_name=subtask)
                ...
                if selected_prev_by_guard and prefer_expert_when_close:
                    expert_best_output, _expert_score = self.evaluator.select_best(temp_outputs, task_name=subtask)
            ...
            if unresolved_degradations:
                ...
                if round_original_output is not None:
                    ...
                    best_fallback, _ = self.evaluator.select_best(candidates, task_name=fallback_task)
