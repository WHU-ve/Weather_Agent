...
class QualityEvaluator:
    ...
    def __init__(self, weights=None, normalize=True, norm_method='minmax'):
        ...
        self.w_rain_main = float(os.getenv('QE_RAIN_W_MAIN', '0.40'))
        self.w_rain_delta = float(os.getenv('QE_RAIN_W_DELTA', '0.15'))
        self.w_rain_lc = float(os.getenv('QE_RAIN_W_LOCAL_CONTRAST', '0.15'))
        self.w_rain_detail = float(os.getenv('QE_RAIN_W_DETAIL', '0.15'))
        self.w_rain_texture = float(os.getenv('QE_RAIN_W_TEXTURE', '0.15'))

        self.w_haze_main = float(os.getenv('QE_HAZE_W_MAIN', '0.40'))
        self.w_haze_delta = float(os.getenv('QE_HAZE_W_DELTA', '0.15'))
        self.w_haze_lc = float(os.getenv('QE_HAZE_W_LOCAL_CONTRAST', '0.25'))
        self.w_haze_detail = float(os.getenv('QE_HAZE_W_DETAIL', '0.10'))
        self.w_haze_texture = float(os.getenv('QE_HAZE_W_TEXTURE', '0.10'))

        self.w_snow_main = float(os.getenv('QE_SNOW_W_MAIN', '0.35'))
        self.w_snow_delta = float(os.getenv('QE_SNOW_W_DELTA', '0.15'))
        self.w_snow_lc = float(os.getenv('QE_SNOW_W_LOCAL_CONTRAST', '0.10'))
        self.w_snow_detail = float(os.getenv('QE_SNOW_W_DETAIL', '0.25'))
        self.w_snow_texture = float(os.getenv('QE_SNOW_W_TEXTURE', '0.15'))
