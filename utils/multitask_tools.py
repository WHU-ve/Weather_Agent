...
class MPRNet(Tool):
    ...
    def _get_cmd_opts(self) -> list[str]:
        ...
        return [
            ...
            "--input_dir", self.input_dir,
            "--result_dir", self.output_dir,
            "--model_arch_file", str(project_root / f"utils/denoising/tools/MPRNet/{self.opt_task}/MPRNet.py"),
...
class AutoDIR(Tool):
    ...
    def _get_cmd_opts(self) -> list[str]:
        ...
        return [
            ...
            "--cfg-text", 1,
            "--config", str(project_root / "utils/defocus_deblurring/tools/AutoDIR/configs/generate.yaml"),
            "--need-resize"
        ]
